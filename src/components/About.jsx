...
const About = () => {
  ...
  <a 
    href="/Aman_Malik_Frontend_Developer_2025.pdf" 
    download="Aman_Malik_Frontend_Developer_2025.pdf"
    className="px-6 py-3 bg-gradient-to-r from-pink-400 via-purple-500 to-indigo-600 
